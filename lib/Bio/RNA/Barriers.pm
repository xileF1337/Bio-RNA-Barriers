...
and folding kinetics developed at the Institute for Theoretical Biochemistry
(TBI) in Vienna. Note that this module is B<not> written and maintained by the
authors of Barriers.
...
constructor of the results class, and the rest is taken care of automatically.
